// (/* */) is for writing big comments insted of (//) that take space
/*
Nottingham Trent International Collage
Module: IY013
Module Name: Software Design and Implementation
Tutor: Salem Maaji
Name: Abdulla AlObaidli
T-Number: T0099199
*/
#include <iostream>
#include <Windows.h>
...
int main()
{
	...
	cout << "      ####################			   " << endl;
	cout << "        ################			   " << endl;
	cout << "									Nottingham Trent International Collage " << endl;
	cout << "										Module: IY013" << endl;
	cout << "										Module Name: Software Design and Implementation" << endl;
	cout << "										Tutor: Salem Maaji" << endl;
	cout << "										Name: Abdulla AlObaidli" << endl;
	cout << "										T-Number: T0099199" << endl;
...
void GoToXY(int column, int line)
{
	...
	*/
	...
	{
		//Comments a a sign of a good programer, Because comments make the code easy to understand
